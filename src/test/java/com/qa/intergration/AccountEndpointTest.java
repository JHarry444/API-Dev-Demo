...
import main.rest.AccountEndpoint;
...
public class AccountEndpointTest {
	...
	public void testUpdateAccount() {
		Mockito.when(service.updateAccount(1, MOCK_VALUE2)).thenReturn(MOCK_VALUE);
		Assert.assertEquals(MOCK_VALUE, endpoint.updateAccount(1, MOCK_VALUE2));
		Mockito.verify(service).updateAccount(1, MOCK_VALUE2);
	}

	@Test
	public void testDeleteAccount() {
		Mockito.when(service.deleteAccount(1)).thenReturn(MOCK_VALUE);
		Assert.assertEquals(MOCK_VALUE, endpoint.deleteAccount(1));
